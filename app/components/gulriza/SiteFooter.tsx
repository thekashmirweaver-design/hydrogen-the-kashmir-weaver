...
const GOOGLE_REVIEW_URL =
  "https://g.page/r/CSc507MU7rrmEBM/review";
...
const CARE_LINKS = [
  ...
  { to: GOOGLE_REVIEW_URL, label: "Leave a Review", external: true },
] as const;
...
function FootCol({ title, links }: { title: string; links: FootLink[] }) {
  const linkClass = "text-sm text-foreground/85 transition hover:text-accent";
