    ...
    <footer className="mt-32 pt-20" style={{ background: "var(--background)" }}>
      <div className="mx-auto max-w-[1600px] px-6 md:px-10">
        ...
        <div className="grid grid-cols-2 gap-12 py-20 md:grid-cols-5">
          ...
          <FootCol
            ...
            links={[
              ...
              { to: "/collections/solids", label: "Solids" },
              { to: "/collections/sozni", label: "Sozni" },
              { to: "/collections/tilla", label: "Tilla" },
              { to: "/collections/kani", label: "Kani" },
              { to: "/collections/maheen-kari", label: "Maheen Kari" },
            ]}
          />
          <FootCol
            title="Our World"
        ...
        <div className="flex flex-col items-center gap-6 py-8 md:grid md:grid-cols-3 md:items-center">
          ...
          <div className="flex items-center justify-center gap-6 text-[0.65rem] uppercase tracking-widest text-muted-foreground md:justify-end md:text-xs">
