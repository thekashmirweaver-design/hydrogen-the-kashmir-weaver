...
import {useSearchPagePagination} from '~/hooks/use-search-page-pagination';
...
export function SearchView({
  ...
  const {products, currentPage, hasNextPage, hasPreviousPage, handleNextPage, handlePrevPage, isLoading} =
    useSearchPagePagination({
      term,
      initialProducts,
